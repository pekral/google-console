...
describe(GoogleConsole::class, function (): void {
    ...
    describe('setup and data', function (): void {

        describe('creation and client', function (): void {
    ...
    describe('inspection', function (): void {
        ...
        describe('url inspection', function (): void {
            ...
            it('inspectUrl sends languageCode en by default so reason-code mapping receives English coverageState', function (): void {
                $console = createGoogleConsole();
            ...
            it('inspectUrl uses context languageCode when provided (BCP-47)', function (): void {
                $console = createGoogleConsole();
                ...
                $context = new InspectionContext(languageCode: 'cs-CZ');
                $result = $console->inspectUrl('https://example.com/', 'https://example.com/page', null, $context);
        ...
        describe('url inspection - checkIndexStatus and batch', function (): void {
